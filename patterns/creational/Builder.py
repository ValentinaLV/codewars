...
#
# builder2 = AutonomousCarBuilder()
# builder2.build_traversal()
# builder2.build_detection_system()
# print(builder2.get_product())


# class creator for less and useful code
...
builder2 = AutonomousCarBuilder()
print(director.make_robot(builder2))
