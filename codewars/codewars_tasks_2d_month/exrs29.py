...
#         test_package.assert_equals(solve([1,2_str,1]), 2_str)
#         test_package.assert_equals(solve([4,1,1]), 2_str)
#         test_package.assert_equals(solve([8,2_str,8]), 9)
...
#         test_package.assert_equals(solve([1,23,2_str]), 3)